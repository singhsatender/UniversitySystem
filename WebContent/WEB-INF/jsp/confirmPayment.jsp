...
<title>CD Store | Confirm Payment</title>
...
<body onload='document.payment.creditcardnum.focus()'>
	<!-- *** NAVBAR ***
		...
		<div id="content">
			<div class="container">
				...
				<div class="col-md-9" id="checkout">
					...
					<div class="box">
						<form name="payment" method="post" action="orderStatus"
								...
								<div class="row">
									<div class="col-sm-12">
										<div class="form-group">
											<label for="creditcardnum">Credit Card Number</label> <input
												type="text" class="form-control" name="creditcardnum"
												id="creditcardnum" value="${creditCard}"> 
										</div>
									</div>
								</div>
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="form-group">
											<label for="cvv">CVV</label> <input type="text"
												class="form-control" name="cvv" id="cvv" value="${cvv}"> 
										</div>
									</div>
									<div class="col-sm-6">
										<div class="form-group">
											<label for="expirydate">Expiry Date</label> <input
												...
												id="expirydate" value="${expiry}"> 
										</div>
									</div>
								</div>
								<!-- <div class="g-recaptcha" data-sitekey="your_site_key"></div> -->
								<!-- /.row -->
								<div class="captcha"> ${captchaMessage} </div>
								
								<div class="g-recaptcha"
									data-sitekey="6LekbDoUAAAAABwwtJnq1ZlyilLaJn7r90eXIbGj"></div>
							...
							<div class="box-footer">
								<!-- <div class="pull-left">
                                    <a id ="backtoAddress" class="btn btn-default"><i class="fa fa-chevron-left"></i>Back to Address Verification</a>
                                </div> -->
 ...
 _________________________________________________________ -->
	...
	<!-- *** SCRIPTS TO INCLUDE **_______________ -->
