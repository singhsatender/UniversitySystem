...
public class UniversityClient implements Runnable{
	private int ID = 0;
	...
	public UniversityClient (String serverName, int serverPort) {  
		...
		try {  
	    	...
	    	this.start();
	    	System.out.println("Welcome To University of Canada!");
